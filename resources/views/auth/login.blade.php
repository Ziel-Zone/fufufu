...
<head>
  ...
  <title>Login</title> {{-- Judul halaman ini --}}
</head>
<body class="h-full">
  ...
  <header class="bg-white shadow-sm">
    <div class="mx-auto max_w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">Login</h1> {{-- Header untuk halaman ini --}}
    </div>
  </header>
  <main>
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="max-w-md mx-auto bg-white shadow-lg rounded-xl p-8 sm:p-10 border border-gray-200">
            <h2 class="text-3xl font-bold text-gray-900 text-center mb-8">Login ke Akun Anda</h2>

            {{-- Pesan Sukses atau Error Login --}}
            @if (session('status'))
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6"> {{-- Gunakan route helper --}}
                @csrf

                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Alamat Email</label>
                    <input type="email" name="email" id="email" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="email@example.com" value="{{ old('email') }}" required autofocus>
                </div>

                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700 mb-1">Password</label>
                    <input type="password" name="password" id="password" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Password Anda" required>
                </div>
                ...
                <div class="text-center text-sm text-gray-600">
                    Belum punya akun? <a href="/register" class="font-medium text-blue-600 hover:text-blue-500">Daftar di sini</a>
                </div>
            </form>
        </div>
    </div>
