        ...
        <div class="max-w-4xl mx-auto">
            ...
            <form action="/articles" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Judul artikel Anda" value="{{ old('title') }}" required>
                </div>

                <div>
                    <label for="author" class="block text-sm font-medium text-gray-700 mb-1">Nama Penulis</label>
                    <input type="text" name="author" id="author" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Nama Anda" value="{{ old('author') }}" required>
                </div>

                <div>
                    <label for="synopsis" class="block text-sm font-medium text-gray-700 mb-1">Sinopsis (Ringkasan)</label>
                    <textarea name="synopsis" id="synopsis" rows="3" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Ringkasan singkat artikel">{{ old('synopsis') }}</textarea>
                </div>

                <div>
                    <label for="content" class="block text-sm font-medium text-gray-700 mb-1">Isi Artikel</label>
                    <textarea name="content" id="content" rows="10" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Tulis artikel lengkap Anda di sini..." required>{{ old('content') }}</textarea>
                </div>

                {{-- Fitur upload gambar (sementara dikomentari) --}}
                <div>
                    <label for="featured_image" class="block text-sm font-medium text-gray-700 mb-1">Gambar Unggulan</label>
                    <input type="file" name="featured_image" id="featured_image" class="mt-1 block w-full text-sm text-gray-900 border border-gray-300 rounded-md cursor-pointer bg-gray-50 focus:outline-none focus:border-blue-500">
                </div>
