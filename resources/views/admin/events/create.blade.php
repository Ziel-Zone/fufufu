...
<head>
    ...
    <title>{{ $title ?? 'Buat Event' }}</title>
</head>
<body class="h-full">
    <div class="min-h-full">
        <header class="bg-white shadow-sm">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Buat Event</h1>
            </div>
        </header>
                    ...
                    <form action="{{ route('events.store') }}" method="POST"
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title"
                                    ...
                                    placeholder="Masukkan judul event" value="{{ old('title') }}" required>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                        placeholder="Deskripsikan event ini..." required>{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="location" id="location"
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   placeholder="Lokasi event" value="{{ old('location') }}" required>
                        </div>
