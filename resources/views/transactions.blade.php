...
<head>
  ...
  <title>Transactions</title> {{-- Judul halaman ini --}}
</head>
<body class="h-full">
  ...
  <header class="bg-white shadow-sm">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">Transactions</h1> {{-- Judul halaman ini --}}
    </div>
  </header>
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      {{-- Konten UNIK untuk halaman Transaksi --}}
      <header class="mb-8">
